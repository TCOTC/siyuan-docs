		...
		<div class="copy-split__menu">
			...
			<ul class="copy-split__panel" id="copy-page-menu" role="menu" hidden>
				<li role="presentation">
					<button type="button" role="menuitem" class="copy-split__panel-item" id="copy-page-menu-md">
