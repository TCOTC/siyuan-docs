...
let hintObserver: MutationObserver | null = null;

/** 绑定浮动提示；Pagefind 替换搜索按钮后可再调一次 */
export function bindAnchoredFloatingHints(): void {
	...
	hintObserver = new MutationObserver(scheduleRun);
