...
upstream: https://raw.githubusercontent.com/evildmp/diataxis-documentation-framework/main/application.rst
---
...
> Diátaxis is underpinned by [systematic theoretical principles](../understanding/theory.md), but understanding them is not necessary to make effective use of the system.
...
- [Tutorials](../four-modes/tutorials.md) — learning-oriented experiences
- [How-to guides](../four-modes/how-to-guides.md) — goal-oriented directions
- [Reference](../four-modes/reference.md) — information-oriented technical description
- [Explanation](../four-modes/explanation.md) — understanding-oriented discussion
...
- [The compass](../four-modes/compass.md) — a simple tool for direction-finding
- [Workflow](../four-modes/how-to-use-diataxis.md) in Diátaxis
