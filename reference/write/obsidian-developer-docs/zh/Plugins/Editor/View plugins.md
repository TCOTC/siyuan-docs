视图插件是一个[[Editor extensions|editor extension]]，可让您访问编辑器[[Viewport]]。
...
> [!tip]
> 如果您想要进行影响编辑器垂直布局的更改（例如插入块和换行符），则需要使用 [[State fields|state field]]。
...
从您的视图插件中提供[[Decorations]]来更改文档的显示方式。
