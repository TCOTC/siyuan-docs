...
```
**扩展：** [`ItemView`](ItemView)

## 构造函数

|  构造函数|修改器 |描述 |
|  --- | --- | --- |
|  [`(构造函数)(叶)`](FileView/(构造函数).md) |  |构造 <code>FileView</code> 类的新实例 |

## 属性

|  物业 |修改器 |类型 |描述 |
|  --- | --- | --- | --- |
|  [`allowNoFile`](FileView/allowNoFile) |  | <code>布尔值</code> |  |
...
|  [`canAcceptExtension(扩展名)`](FileView/canAcceptExtension) |  |  0.9.7 |
...
|  [`onLoadFile(文件)`](FileView/onLoadFile) |  |  |
...
|  [`onUnloadFile(文件)`](FileView/onUnloadFile) |  |  |
...
|  [`setState(状态，结果)`](FileView/setState) |  |  0.9.7 |
