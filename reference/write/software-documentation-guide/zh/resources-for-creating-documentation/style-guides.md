---
source_url: https://www.writethedocs.org/writing/style-guides/
source_file: docs/guide/writing/style-guides.md
...
> **中文说明**：本页资源链接与章节结构与英文版一致，小节标题保留英文以匹配目录锚点；正文目前与英文镜像相同。欢迎后续提交 PR 补充逐段译文。
...
- [Write the Docs Official Website Style Guide](./style-guides.md)
...
- [Reducing bias in your writing](reducing-bias.md)
...
- *[How I Learned to Stop Worrying and Love the Command Line](https://www.youtube.com/watch?v=YfM220sNVp8)* from WTD Portland 2019
