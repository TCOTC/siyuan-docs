---
source_url: https://www.writethedocs.org/writing/markdown/
source_file: docs/guide/writing/markdown.md
...
> **中文说明**：正文与英文镜像相同；标题与锚点保留英文。可结合本站 [reStructuredText 简介](reStructuredText.md) 对照阅读。
...
![](https://www.writethedocs.org/_static/img/guide/markdown-headers.png)
