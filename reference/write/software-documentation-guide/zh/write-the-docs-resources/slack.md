...
> [!TIP]
> 由于垃圾信息增多，加入 Slack 网络前需要先填写一份简短的[报名表单](https://www.writethedocs.org/slack/)。

感谢你对 Write the Docs Slack 网络的关注。已有许多成员加入，你也可以成为其中之一。

我们的 Slack 上有大量关于文档的讨论，是与社区保持联系、以及在会议与 meetup 之后继续交流的好方式。

下面列出最活跃的频道，帮助你找到志同道合的人。请认真阅读 Slack 指南；[行为准则](https://www.writethedocs.org/code-of-conduct/)同样适用于 Slack。

若你想参与：

- 填写[报名表单](https://www.writethedocs.org/slack/)加入网络。  
- 若希望补充你喜爱的频道，欢迎向 [GitHub 上的本页源码](https://github.com/writethedocs/www/blob/master/docs/slack.rst) 提交 PR。

> [!NOTE]
> Slack 中包含动图表情等动画内容。若你对此敏感，可在客户端中[关闭动画](https://get.slack.help/hc/en-us/articles/228023907-Manage-animated-images-and-emoji)。
