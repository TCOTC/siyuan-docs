...
<!-- 正文合并自 docs/guide/tools/sphinx.rst、sphinx-themes.rst、sphinx-community.rst、testing.rst；章节标题与锚点与英文版一致，便于目录链接。 -->

# Tools for documentation writing

撰写文档离不开合适工具。本页汇总 Write the Docs 社区常用的文档工具，尤其侧重技术文档领域广泛使用的 Sphinx 及其生态。

下文在结构上对应官网 `/tools/` 页面：先深入 Sphinx，再列举其他常见工具，最后讨论测试与质量保障。
