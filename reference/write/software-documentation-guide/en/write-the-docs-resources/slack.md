---
source_url: https://www.writethedocs.org/slack/
source_file: docs/slack.rst
...
> [!TIP]
> Due to an increase in spammers, we now have a short [signup form](https://www.writethedocs.org/slack/) that you must fill out to join our Slack network.

Thanks for your interest in our Slack network.
We have many people who have joined,
...
[Code of Conduct](https://www.writethedocs.org/code-of-conduct/) also applies to our Slack.

If you want to get involved you can:

- Fill out our [signup form](https://www.writethedocs.org/slack/) to join our network.
- Feel free to send a Pull Request to update [this page](https://github.com/writethedocs/www/blob/master/docs/slack.rst), if you want to include other channels you enjoy.

> [!NOTE]
> Our Slack includes animated emoji, and other animations are sometimes posted.
> If you think these may be unpleasant for you, you can [disable all animations](https://get.slack.help/hc/en-us/articles/228023907-Manage-animated-images-and-emoji)
...
- React to a message with `:suggest-for-newsletter:` emoji to nominate it for inclusion in our next monthly newsletter.
  Read the [newsletter archives](https://www.writethedocs.org/newsletter/) and subscribe if you want them directly in your inbox!
- Contribute a summary to one of the Write the Docs site's [learning resources](https://www.writethedocs.org/about/learning-resources/).
- Turn a discussion into a talk proposal for [an upcoming Write the Docs conference](https://www.writethedocs.org/conf/).
- [Save a message](https://slack.com/intl/en-gb/help/articles/360042650274-Save-messages-and-files-) privately in Slack.
- Recap what you learned and share it on your own site or social media accounts. Don't forget to tag <span class="title-ref">\#writethedocs</span>!

<div class="admonition note">

Why we don't pay for Slack
...
- `?conferences` / `?conference`
  - Get information on past and future Write the Docs [conferences](https://www.writethedocs.org/conf/).
- `?jobseeking` / `?hiring` / `?interview` / `?interviewing`
  - Get information on both hiring and getting hired, including a link to the [hiring guide](https://www.writethedocs.org/hiring-guide/).
- `?getstarted` / `?resources` / `?learn`
  - We're always excited to help new people into working on documentation! This is for you if you want some resources on how to get started, including a link to some of our favorite [learning resources](https://www.writethedocs.org/about/learning-resources/).
...
- `?coc`
  - "COC" is short for the [Code of Conduct](https://www.writethedocs.org/code-of-conduct/). This is an easy way to get a link to it, and to summon a member of the moderation team if you need one.
- `?mods` / `?moderators` / `?modsquad`
  - Returns the members of the moderation team if you need to ping someone directly for help.
- `?history`
...
The Write the Docs Slack has <span id="lots">lots</span>\_ of channels.
...
- **\#wtd-conferences** - Questions and discussion for [Write the Docs conferences](https://www.writethedocs.org/conf/). (Talk about other conferences in **\#community-events**.)
- **\#meetups** - Questions and discussion for Write the Docs [meetups](https://www.writethedocs.org/meetups/). (Talk about other meetups in **\#community-events**.)
...
- **\#bipoc** - Social and discussion space for Write the Docs' [BIPOC](https://www.writethedocs.org/bipoc/) community.
...
1.  Find two other people to cosponsor your channel idea.
...
3.  Post in **\#meta** requesting a channel.
    Be sure to share your proposed channel name, description, and to tag your cosponsors.
4.  Start thinking about how to seed the new channel with discussion, with an open-ended question, a link to discuss, or a hot take.
...
1.  Seed discussion in the new channel.
...
2.  Make an announcement in **\#general** and channels related to the new channel's topic.
...
Our [Code of Conduct](https://www.writethedocs.org/code-of-conduct/) applies to all spaces associated with Write the Docs, which includes our Slack.
...
We also recommend reading [Microaggressions: Making space for everybody](https://www.metafilter.com/microaggressions.mefi), which goes over how to avoid small slights and hurtful behaviors, especially against members of marginalized groups.
...
- **Honor the community's trust and confidence.**
  ...
  The [Chatham House Rule](https://www.chathamhouse.org/about-us/chatham-house-rule) applies: you're welcome to use the information shared, but never reveal names, job titles, employers, or other identifying information about other participants outside of Slack, unless you've received their explicit permission to do so.
...
Posts not meeting these criteria may result in moderation action, such as a warning or deletion.
...
- **Treat the community like friends, not customers.**
  ...
  Avoid calls to action — [attempts to prompt an immediate response or sale](https://en.wikipedia.org/wiki/Call_to_action_(marketing)) — such as requests to "buy", "subscribe", "retweet", or "share" (among others).
...
- **\#community-events** (formerly known as <span class="title-ref">\#calls-for-papers</span>) is a good place to announce non-Write the Docs events.
...
Posts in those channels not meeting the posting rules may result in moderation action, such as a warning or deletion.
...
- Ask the moderation team (in the **\#meta** channel or by DM) to address the situation.
...
This concept is inspired by the [Recurse Center's Social Rules](https://www.recurse.com/manual#sub-sec-social-rules).
