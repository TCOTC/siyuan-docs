---
source_url: https://www.writethedocs.org/doc-ops/
source_file: docs/guide/doc-ops.rst
...
Along with the advent of `/guide/docs-as-code`, the technical writing community
...
Generally speaking, "DocOps" is like [DevOps](https://www.atlassian.com/devops). Instead of applying broadly to
...
[\#docops](https://writethedocs.slack.com/archives/C62BVHJ7K) channel!

- [CA Technologies](https://www.k15t.com/blog/2014/12/webinar-how-ca-technologies-broke-the-rules-the-docops-approach-to-agile-technical-content) was among the first to publicly use the term "DocOps" to
  describe their approach to technical content
- [Chris Noonan](https://www.youtube.com/watch?v=2HjeYNs2z7o) presented on the "Rocky Road to DocOps" at WTD Europe in 2020
- [Doc Tool Hub](https://doctoolhub.com/collection/docops/) provides a curated list of DocOps-related articles and blog posts.
