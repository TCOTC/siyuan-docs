...
[Fabric](http://docs.fabfile.org/) does a great job of this.

### Provide a small code example

Show a common example use case for your project.

[Requests](https://requests.kennethreitz.org/en/master/) is a great example.
...
The [Python Guide](http://docs.python-guide.org/en/latest/index.html) does a good job of this.
...
[Django](https://docs.djangoproject.com/en/1.8/faq/help) does a great job at this.
...
[Read the Docs](https://docs.readthedocs.com/dev/latest/install.html) does a good job with this.
...
see [how to maintain an open source project](https://medium.com/p/aaa2a5437d3a).
...
<div id="markup_languages">

<div class="sidebar">

**Sidebar on markup languages.**

The examples in this document are both valid [Markdown](http://daringfireball.net/projects/markdown/) and [reStructuredText](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html).
